...
if __name__ == "__main__":
    ...
    # os.system("python test.py --dataset primitive_room_ff_no_albedo --model DEL_no_albedo_24.pth")
    # os.system("python test.py --dataset primitive_room_ff_no_depth --model DEL_no_depth_24.pth")
    # os.system("python test.py --dataset primitive_room_ff_no_direct --model DEL_no_direct_24.pth")
    # os.system("python test.py --dataset primitive_room_ff_no_normal --model DEL_no_normal_24.pth")
    ...
    # DIFDUBBEL
    # os.system("python test.py --dataset primitive_room_ffextra --model DIF_24.pth --gt_name indirect")
    ...
    # GLOSSYVAST
    os.system("python test.py --dataset primitive_room_ff2 --model GLOSvast_39.pth --gt_name indirect")


    # GLOSSYVAR
    os.system("python test.py --dataset primitive_room_ff3 --model GLOSvar_39.pth --gt_name indirect")
